  ...
  return (
    <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
        <div className="w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <h2 className="text-ul font-semibold mb-4">Please Register</h2>
            ...
            <p className='align-baseline font-medium mt-4 text-sm'>Already have an account? Please<Link to="/login" className="text-blue-500">Login</Link></p>
            {/* google sign in */}
            <div className="mt-4">
